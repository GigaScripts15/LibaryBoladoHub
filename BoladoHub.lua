-- BoladoHub Library v2.0 - UI Reduzida
...
function BoladoHub.new(options)
    ...
    -- Configurações com tamanho reduzido
    self.Config = {
        Name = options.Name or "BoladoHub",
        Size = options.Size or UDim2.new(0, 350, 0, 300), -- TAMANHO REDUZIDO (550x450 → 350x300)
...
function BoladoHub:CreateUI()
    ...
    corner.CornerRadius = UDim.new(0, 10) -- Reduzido
    corner.Parent = self.MainFrame
    
    -- Shadow reduzida
    local shadow = Instance.new("ImageLabel")
    shadow.Name = "Shadow"
    shadow.Size = UDim2.new(1, 8, 1, 8) -- Reduzido
    shadow.Position = UDim2.new(0, -4, 0, -4) -- Reduzido
...
function BoladoHub:CreateTitleBar()
    ...
    self.TitleBar.Size = UDim2.new(1, 0, 0, 35) -- Reduzido
    ...
    titleCorner.CornerRadius = UDim.new(0, 10, 0, 0) -- Reduzido
    titleCorner.Parent = self.TitleBar
    
    -- Ícone do título menor
    local titleIcon = Instance.new("ImageLabel")
    titleIcon.Name = "TitleIcon"
    titleIcon.Size = UDim2.new(0, 22, 0, 22) -- Reduzido
    titleIcon.Position = UDim2.new(0, 8, 0.5, -11) -- Ajustado
    ...
    self.TitleLabel.Position = UDim2.new(0, 35, 0, 0) -- Ajustado
    self.TitleLabel.BackgroundTransparency = 1
    self.TitleLabel.Text = "  " .. self.Config.Name
    self.TitleLabel.TextColor3 = theme.Text
    self.TitleLabel.Font = Enum.Font.GothamBold
    self.TitleLabel.TextSize = 14 -- Reduzido
...
function BoladoHub:CreateTitleButtons()
    local buttonSize = UDim2.new(0, 28, 0, 28) -- Reduzido
    ...
    if self.Config.ShowMinimize then
        ...
        self.MinimizeBtn.Position = UDim2.new(1, -62, 0.5, -14) -- Ajustado
    ...
    if self.Config.ShowClose then
        ...
        self.CloseBtn.Position = UDim2.new(1, -30, 0.5, -14) -- Ajustado
...
function BoladoHub:CreateTabSystem()
    ...
    self.TabsFrame.Size = UDim2.new(0, 120, 1, -35) -- Reduzido
    self.TabsFrame.Position = UDim2.new(0, 0, 0, 35) -- Ajustado
    ...
    self.ContentFrame.Size = UDim2.new(1, -120, 1, -35) -- Ajustado
    self.ContentFrame.Position = UDim2.new(0, 120, 0, 35) -- Ajustado
...
function BoladoHub:AddTab(name, icon)
    ...
    tabButton.Size = UDim2.new(1, 0, 0, 40) -- Reduzido
    ...
    -- Corner
    local corner = Instance.new("UICorner")
    corner.CornerRadius = UDim.new(0, 7) -- Reduzido
    ...
    if icon then
        ...
        iconImage.Name = "Icon"
        iconImage.Size = UDim2.new(0, 22, 0, 22) -- Reduzido
        iconImage.Position = UDim2.new(0, 12, 0.5, -11) -- Ajustado
    ...
    textLabel.Size = UDim2.new(1, -45, 1, 0) -- Ajustado
    textLabel.Position = UDim2.new(0, 40, 0, 0) -- Ajustado
    ...
    listLayout.Padding = UDim.new(0, 10) -- Reduzido
...
function BoladoHub:Button(options)
    ...
    buttonContainer.Size = UDim2.new(1, 0, 0, 45) -- Reduzido
    ...
    if icon then
        ...
        iconLabel.Name = "Icon"
        iconLabel.Size = UDim2.new(0, 26, 0, 26) -- Reduzido
        iconLabel.Position = UDim2.new(0, 12, 0.5, -13) -- Ajustado
    ...
    local textLabel = Instance.new("TextLabel")
    textLabel.Name = "Label"
    textLabel.Size = UDim2.new(1, icon and -55 or -25, 1, 0) -- Ajustado
    textLabel.Position = UDim2.new(0, icon and 50 or 12, 0, 0) -- Ajustado
    textLabel.BackgroundTransparency = 1
    textLabel.Text = text
    ...
    buttonContainer.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(buttonContainer, TweenInfo.new(0.1), {
            Size = UDim2.new(1, -8, 0, 40) -- Ajustado
        }):Play()
        
        task.wait(0.1)
        
        TweenService:Create(buttonContainer, TweenInfo.new(0.1), {
            Size = UDim2.new(1, 0, 0, 45) -- Ajustado
        }):Play()
...
function BoladoHub:Toggle(options)
    ...
    toggleContainer.Size = UDim2.new(1, 0, 0, 45) -- Reduzido
    ...
    if icon then
        iconLabel = Instance.new("ImageLabel")
        iconLabel.Name = "Icon"
        iconLabel.Size = UDim2.new(0, 22, 0, 22) -- Reduzido
        iconLabel.Position = UDim2.new(0, 0, 0.5, -11) -- Ajustado
        iconLabel.BackgroundTransparency = 1
        iconLabel.Image = Icons:Get(icon)
    ...
    local textLabel = Instance.new("TextLabel")
    textLabel.Name = "Label"
    textLabel.Size = UDim2.new(0.7, icon and -35 or 0, 1, 0) -- Ajustado
    textLabel.Position = UDim2.new(0, icon and 27 or 0, 0, 0) -- Ajustado
    textLabel.BackgroundTransparency = 1
    textLabel.Text = text
    textLabel.TextColor3 = self:GetColor("Text")
    textLabel.Font = Enum.Font.Gotham
    ...
    toggleBtn.Size = UDim2.new(0, 55, 0, 28) -- Reduzido
    toggleBtn.Position = UDim2.new(1, -55, 0.5, -14) -- Ajustado
    ...
    indicator.Size = UDim2.new(0, 22, 0, 22) -- Reduzido
    indicator.Position = default and UDim2.new(1, -23, 0.5, -11) or UDim2.new(0, 1, 0.5, -11) -- Ajustado
...
function BoladoHub:Slider(options)
    ...
    sliderContainer.Size = UDim2.new(1, 0, 0, 65) -- Reduzido
    ...
    local textLabel = Instance.new("TextLabel")
    textLabel.Name = "Label"
    textLabel.Size = UDim2.new(1, 0, 0, 22) -- Reduzido
    textLabel.BackgroundTransparency = 1
    ...
    sliderTrack.Position = UDim2.new(0, 0, 0, 32) -- Ajustado
...
function BoladoHub:Label(options)
    ...
    local size = options.Size or 13 -- Reduzido
    local align = options.Align or Enum.TextXAlignment.Left
    
    local label = Instance.new("TextLabel")
    label.Name = "Label"
    label.Size = UDim2.new(1, 0, 0, 28) -- Reduzido
...
return BoladoHub    corner.Parent = self.MainFrame
